        ...
        private AmmoDef Starcore_L_Laser_Ammo => new AmmoDef // StarCore AMS I
        {
            ...
            Pattern = new PatternDef
            {
                Patterns = new[] { // If enabled, set of multiple ammos to fire in order instead of the main ammo.
                    "Starcore Large Laser","Starcore Large Laser Fake","Starcore Large Laser Fake","Starcore Large Laser Fake","Starcore Large Laser Fake",
                },
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                {
                    Distance = 3250f, // Distance at which damage begins falling off.
