...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Starcore_SSRM => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Starcore_SSRM_Block", // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Muzzles = new[] {
                    "SSRM_barrel_01", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                    "SSRM_barrel_02",
                    "SSRM_barrel_03",
                    "SSRM_barrel_04",
                    "SSRM_barrel_05",
            ...
            {
                PartName = "SSRM", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
