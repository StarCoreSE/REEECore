...
namespace Scripts
{
    partial class Parts
    {
        ...
        WeaponDefinition Starcore_MRM => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Starcore_MRM_Block",
                    ...
                    new MountPointDef {
                        SubtypeId = "Starcore_MRM45_Block",
                        SpinPartId = "", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "None", // The subpart where your muzzle empties are located.
                        AzimuthPartId = "None",
                        ElevationPartId = "None",
                ...
                Scope = "scope_MRM", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            Targeting = new TargetingDef
            {
                ...
                TopBlocks = 32, // Maximum number of blocks to randomize between; 0 = unlimited.
            ...
            HardPoint = new HardPointDef
            {
                ...
                {
                    RateOfFire = 1700, // Set this to 3600 for beam weapons.
            ...
            Ammos = new[] {
              Starcore_MRM_Launch,
              Starcore_MRM_Acceleration,
              Starcore_MRM_Terminal,
              Starcore_MRM_Terminal_Sabot,
              Starcore_MRM_Terminal_Sabot_Fragment,
              //Starcore_MRM_Terminal_Sabot_Dummy// Must list all primary, shrapnel, and pattern ammos.
            },
