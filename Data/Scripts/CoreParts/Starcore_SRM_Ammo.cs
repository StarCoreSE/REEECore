...
{ // Don't edit above this line
                    ...
                    Types = new[] // List of blocks to apply custom damage multipliers to.
    {
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                {
                    SteeringLimit = 115, // 0 means no limit, value is in degrees, good starting is 150.  This enable advanced smart "control", cost of 3 on a scale of 1-5, 0 being basic smart.
                    Inaccuracy = 6f, // 0 is perfect, hit accuracy will be a random num of meters between 0 and this value.
                    Aggressiveness = 1.5f, // controls how responsive tracking is, recommended value 3-5.
                    ...
                    NavAcceleration = 0.1, // helps influence how the projectile steers, 0 defaults to 1/2 Aggressiveness value or 0 if its 0, a value less than 0 disables this feature. 
        ...
        private AmmoDef Starcore_SSRM_Acceleration => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                DesiredSpeed = 900, // voxel phasing if you go above 5100
                MaxTrajectory = 8000, // Max Distance the projectile or beam can Travel.
                DeaccelTime = 0, // 0 is disabled, a value causes the projectile to come to rest overtime, (Measured in game ticks, 60 = 1 second)
                GravityMultiplier = 0f, // Gravity multiplier, influences the trajectory of the projectile, value greater than 0 to enable. Natural Gravity Only.
                SpeedVariance = Random(start: 0, end: 0), // subtracts value from DesiredSpeed. Be warned, you can make your projectile go backwards.
                RangeVariance = Random(start: 0, end: 0), // subtracts value from MaxTrajectory
                ...
                Smarts = new SmartsDef
                {
                    SteeringLimit = 110, // 0 means no limit, value is in degrees, good starting is 150.  This enable advanced smart "control", cost of 3 on a scale of 1-5, 0 being basic smart.
                    ...
                    OffsetRatio = 0.69f, // The ratio to offset the random direction (0 to 1) 
