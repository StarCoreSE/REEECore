...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Starcore_LRM => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "Starcore_LRM45_Block", // Block Subtypeid. Your Cubeblocks contain this information
                    ...
                    new MountPointDef {
                        SubtypeId = "Starcore_LRM_Block", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "None", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "None", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "None",// Your Elevating Subpart, that bit that moves up
                ...
                Muzzles = new[] {
                "LRM_barrel_01",// Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                "LRM_barrel_02",
                "LRM_barrel_03",
                 "LRM_barrel_04",
                 "LRM_barrel_05",
                ...
                Scope = "scope_LRM", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            Targeting = new TargetingDef
            {
                ...
                TopBlocks = 21, // Maximum number of blocks to randomize between; 0 = unlimited.
                StopTrackingSpeed = 0, // Do not track threats traveling faster than this speed; 0 = unlimited.
            },
            HardPoint = new HardPointDef
            {
                PartName = "LRM", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                Starcore_LRM_Launch,
                Starcore_LRM_Smart_Terminal,
                Starcore_LRM_Smart_Detonation,// Must list all primary, shrapnel, and pattern ammos.
            },
